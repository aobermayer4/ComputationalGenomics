...
source("~/R/ComputationalGenomics/Lesson13/Rsource/source.R")
```
...
demo_microbiome_fasqfiles <- "~/R/ComputationalGenomics/Lesson13/Rdata/fastq"
...
pdf("~/R/ComputationalGenomics/Lesson13/Rfigs/demo_F_quality.pdf",
    width = 12,
    height = 8,
    pointsize = 8)
...
pdf("~/R/ComputationalGenomics/Lesson13/Rfigs/demo_R_quality.pdf",
    width = 12,
    height = 8,
    pointsize = 8)
...
demo_goodF <- file.path("~/R/ComputationalGenomics/Lesson13/Routput/demo_good_filtered",
                        paste0(demo_samplenames,
                               "F_good.fastq.gz"))
demo_goodR <- file.path("~/R/ComputationalGenomics/Lesson13/Routput/demo_good_filtered",
                        paste0(demo_samplenames,
                               "R_good.fastq.gz"))
...
demo_good_proper <- filterAndTrim(demo_F,      # paths to forward fastq files
                                  ...
                                  truncQ = 12, # adjusted from 2 to 12 # truncates reads at the first instance of a quality score less than or equal to '12'
                                  maxN = 0, # after truncation, sequences with more than '0' will be discarded
                                  minQ=4, # adjusted from 1 to 4 # after truncation, reads contain a quality score < '4' will be discarded
                                  maxEE = c(1, 2), # adjusted from (2,4) to (1,2) # after truncation, reads with higher than maxEE "expected errors" will be discarded
...
write.table(demo_good_proper,
            file = "~/R/ComputationalGenomics/Lesson13/Routput/demo_filteredout.txt",
            sep = "\t",
            quote = FALSE)
...
pdf("~/R/ComputationalGenomics/Lesson13/Rfigs/demo_error_F_plot.pdf",
    width = 10,
    height = 10,
    pointsize = 8)
plotErrors(demo_error_F,
...
pdf("~/R/ComputationalGenomics/Lesson13/Rfigs/demo_error_R_plot.pdf",
    width = 10,
    height = 10,
    pointsize = 8)
...
write.table(demo_track_steps,
            file = "~/R/ComputationalGenomics/Lesson13/Routput/demo_filtering_steps_track.txt",
            sep = "\t",
            quote = FALSE)
```
...
demo_taxonomy <- assignTaxonomy(demo_nochim, # character vector of the sequences to be assigned
                                "~/R/ComputationalGenomics/Lesson13/Rdata/Silva_db/silva_nr_v132_train_set.fa", # the path to the reference fasta file
                                minBoot = 80, # min bootstrap confidence for assigning a taxonomic level
                                verbose = TRUE,
                                multithread = TRUE)

write.table(demo_taxonomy,file = "~/R/ComputationalGenomics/Lesson13/Routput/demo_taxaout.txt",
            sep = "\t",
            quote = FALSE)
...
write(demo_asv.fasta,
      file = "~/R/ComputationalGenomics/Lesson13/Routput/demo_out_asv.fasta")
...
write.table(demo_asv_tab,
            file = "~/R/ComputationalGenomics/Lesson13/Routput/demo_asv_counts.tsv",
            sep = "\t",
            quote=FALSE,
            col.names = NA)
...
write.table(demo_asv_taxa,file = "~/R/ComputationalGenomics/Lesson13/Routput/demo_asvs_taxonomy.tsv",
            sep = "\t",
            quote=FALSE,
            col.names = NA)
dim(demo_asv_taxa)
...
write.table(demo_rarefied$otu.tab.rff, "~/R/ComputationalGenomics/Lesson13/Routput/demo_rar_table.txt", sep = "\t")

write.table(demo_rarefied$discard, "~/R/ComputationalGenomics/Lesson13/Routput/demo_rar_discard.txt", sep = "\t")
...
write.table(demo_final, "~/R/ComputationalGenomics/Lesson13/Routput/demo_final_count_table.txt", sep = "\t")
```
...
write.table(demo_fake_sample_data,
            file = "~/R/ComputationalGenomics/Lesson13/Routput/made_up_sample_data.tsv",
            sep="\t",
            quote=FALSE)
```
