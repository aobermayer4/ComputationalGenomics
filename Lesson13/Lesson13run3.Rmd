...
demo_good_proper <- filterAndTrim(demo_F,      # paths to forward fastq files
                                  ...
                                  truncLen = c(120, # chopped off 30 bases instead of 5 # The first number indicates the instruction for forward and the second is for reverse.
                                               95), # Chopped off 50 bases instead of 10 #  reads shorter than this are discarded
